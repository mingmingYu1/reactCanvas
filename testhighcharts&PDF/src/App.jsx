...
import { HeadNav, HeadNavItem } from 'public/HeaderNav'
import env from './env'
import './App.less'
      ...
      return (
        <div id="wrapper" className="container-fluid">
          <div id="header" className="row">
            <Link to={env.basePath} className="logo pull-left">
              <span>PROJECT NAME</span>
            </Link>
            <Nav href={env.basePath} className="headerNav pull-left">
              <NavItem href="overview" title="企业管理" />
              <NavItem href="data" title="评分模型" />
              <NavItem href="system" title="系统管理" />
            </Nav>
