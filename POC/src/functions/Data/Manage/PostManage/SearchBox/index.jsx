	...
	render() {
		return (
	        ...
	        <div className={classNames('search-choose', {'choose-boolean': this.state.chooseBoolean})}>
	        	<ul>
              <li onClick={this.searchBtnClick.bind(this, 'g.NAME')}>
                <div>
                  <span>组织名称：</span>
        ...
        <input onClick={this.searchBtnClick.bind(this, 'r.NAME')} className="pull-right search-btn" type="button" value="搜索" />
      </div>
		)
	}
})