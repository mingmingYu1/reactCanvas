...
export default React.createClass({
  ...
  handleRowClick(row){
    this.props.history.replaceState(null,'/data/details',{id:row.id},);
    ...
    return (
      <div className="collection-box">
        <RecentCollection history={this.props.history}></RecentCollection>
          ...
          <Fetch url={URL.QUERY_PERSONAL_COLLECTION+'?data='+JSON.stringify(this.state.param)} onSuccess={this.handleTableAjax}>
          </Fetch>
